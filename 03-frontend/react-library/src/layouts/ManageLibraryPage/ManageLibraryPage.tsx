...
export const ManageLibraryPage = () => {
    ...
    //Changing the states using below functions on click so that it will trigger useEffect each time when user clicks on tab
    ...
    // To allow only admin users to access /admin page and re-route other users to /home page
