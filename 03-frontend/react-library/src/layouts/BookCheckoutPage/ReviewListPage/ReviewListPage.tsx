...
export const ReviewListPage = () => {
    ...
    const indexOfLastReivew: number = currentPage * reviewsPerPage;
    const indexofFirstReview: number = indexOfLastReivew - reviewsPerPage;
    ...
    return (
        <div className="container m-5">
            ...
            <p>
                {indexOfLastReivew + 1} to {lastItem} of {totalAmountOfReviews} items:
            </p>
            <div className="row">
                {reviews.map(review => (
